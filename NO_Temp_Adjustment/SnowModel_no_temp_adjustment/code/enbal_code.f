...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  al_dec_melt,dt,sprec,Qp,albedo_flag,Tcanopy_adjust,
     &  Tcanopy_adjust_flag)
     ...
     &  count_Tsfc_not_converged,albedo_diff,al_max,
...
c   not have to do this (I could pass in subsections of the arrays).
          ...
          if (Tcanopy_adjust_flag .eq. 1) then 
            CALL ENBAL_CORE(Tcanopy_adjust(i,j),windspd,rh_grid(i,j),
